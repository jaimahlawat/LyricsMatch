...
import com.dragedy.playermusic.lyricspack.model.Recents;
import com.dragedy.playermusic.lyricspack.model.Track;
...
public class MusicBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        autoUpdate = autoUpdate || sharedPref.getBoolean("pref_auto_refresh", true);
        ...
        if (notificationPref != 0 && isPlaying
            ...
            Intent wearableIntent = new Intent("com.dragedy.playermusic.lyricspack.SEND_TO_WEARABLE")
