...
import com.dragedy.playermusic.lyricspack.adapter.IntroScreenSlidePagerAdapter;
import com.dragedy.playermusic.lyricspack.broadcastReceiver.MusicBroadcastReceiver;
import com.dragedy.playermusic.lyricspack.fragment.LocalLyricsFragment;
import com.dragedy.playermusic.lyricspack.fragment.LyricsViewFragment;
import com.dragedy.playermusic.lyricspack.fragment.RecentTracksFragment;
...
import com.dragedy.playermusic.lyricspack.tasks.DBContentLister;
import com.dragedy.playermusic.lyricspack.tasks.Id3Writer;
import com.dragedy.playermusic.lyricspack.tasks.IdDecoder;
import com.dragedy.playermusic.lyricspack.utils.ChangelogStringBuilder;
import com.dragedy.playermusic.lyricspack.utils.ColorUtils;
import com.dragedy.playermusic.lyricspack.utils.DatabaseHelper;
import com.dragedy.playermusic.lyricspack.utils.IMMLeaks;
import com.dragedy.playermusic.lyricspack.utils.LyricsSearchSuggestionsProvider;
import com.dragedy.playermusic.lyricspack.utils.NightTimeVerifier;
import com.dragedy.playermusic.lyricspack.utils.RefreshButtonBehavior;
import com.dragedy.playermusic.lyricspack.utils.Spotify;
...
import static com.dragedy.playermusic.R.array;
import static com.dragedy.playermusic.R.id;
import static com.dragedy.playermusic.R.layout;
import static com.dragedy.playermusic.R.string;
...
public class MainActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        themeNum = Integer.valueOf(sharedPref.getString("pref_theme", "7"));
        ...
        if (receivedLyrics != null) {
            ...
            if ("com.dragedy.playermusic.lyricspack.getLyrics".equals(s) && intent.getStringArrayExtra("TAGS") != null) {
        ...
        if (action != null) {
            switch (action) {
                ...
                case "android.intent.action.VIEW":
                    ...
                    break;
                case "com.dragedy.playermusic.lyricspack.getLyrics":
                    String[] metadata = intent.getStringArrayExtra("TAGS");
                    if (metadata != null) {
                        String artist = metadata[0];
                        String track = metadata[1];
                    ...
                    break;
                case "com.dragedy.playermusic.lyricspack.updateDBList":
                    updateDBList();
                    break;
            }
        }
