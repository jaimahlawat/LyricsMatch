...
import com.dragedy.playermusic.lyricspack.fragment.SettingsFragment;
import com.dragedy.playermusic.lyricspack.utils.NightTimeVerifier;
import com.dragedy.playermusic.lyricspack.view.ColorGridPreference;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    public int getSelectedTheme() {
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(this);
        return Integer.valueOf(sharedPref.getString("pref_theme", "7"));
    }
