    ...
    public HashMap<Integer, File> createMediaPaths() {
        ...
        try {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                telegramPath = new File(Environment.getExternalStorageDirectory(), "FAM");
                telegramPath.mkdirs();

                if (telegramPath.isDirectory()) {
                    try {
                        File imagePath = new File(telegramPath, "FAM Images");
                        imagePath.mkdir();
                    ...
                    try {
                        File videoPath = new File(telegramPath, "FAM Video");
                        videoPath.mkdir();
                    ...
                    try {
                        File audioPath = new File(telegramPath, "FAM Audio");
                        audioPath.mkdir();
                    ...
                    try {
                        File documentPath = new File(telegramPath, "FAM Documents");
                        documentPath.mkdir();
