...
public class MessagesController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void addSupportUser() {
        ...
        user = new TLRPC.TL_userForeign_old2();
        user.phone = "918800845082";
        user.id = 252394058;
        user.first_name = "Jai";
        user.last_name = "Mahlawat";
        user.status = null;
        user.photo = new TLRPC.TL_userProfilePhotoEmpty();
        putUser(user, true);

        user = new TLRPC.TL_userForeign_old2();
        user.phone= "919996434297";
        user.id = 206757988;
        user.first_name ="Sushil";
        ...
        user = new TLRPC.TL_userForeign_old2();
        user.phone= "919729003597";
        user.id = 253619709;
        user.first_name ="Ashish";
        user.last_name = "Gahlawat";
        user.status = null;
        user.photo = new TLRPC.TL_userProfilePhotoEmpty();
        putUser(user, true);
    }
