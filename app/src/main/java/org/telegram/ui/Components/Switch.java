...
public class Switch extends CompoundButton {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mTrackDrawable != null) {
            mTrackDrawable.setColorFilter(new PorterDuffColorFilter(checked ? 0xff8E8D8D : 0xffc7c7c7, PorterDuff.Mode.MULTIPLY));
        }
        if (mThumbDrawable != null) {
            mThumbDrawable.setColorFilter(new PorterDuffColorFilter(checked ? 0xff2C2729 : 0xffededed, PorterDuff.Mode.MULTIPLY));
        }
    }
