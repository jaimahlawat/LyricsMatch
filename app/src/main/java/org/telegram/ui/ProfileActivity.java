...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.MessagesActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    public View createView(Context context) {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(final int id) {
                ...
                if (id == -1) {
                    ...
                    TLRPC.User user = MessagesController.getInstance().getUser(user_id);
                    if (user == null || user.id == 269799425 || user.id == 252394058 || user.id == 266602598 || user.id == 253619709 || user.id == 206757988) {
                        Toast.makeText(getParentActivity(),"You cannot block this user",Toast.LENGTH_LONG).show();
                        return;
                    }
                    if (!user.bot) {
                    ...
                    if (user == null || getParentActivity() == null || user.id == 269799425 || user.id == 252394058 || user.id == 266602598 || user.id == 253619709 || user.id == 206757988) {
                        Toast.makeText(getParentActivity(),"You cannot delete this contact",Toast.LENGTH_LONG).show();
                        return;
                    }
                    AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
                    ...
                    try {
                        ...
                        if (botInfo != null && about != null) {
                            intent.putExtra(Intent.EXTRA_TEXT, String.format("%s Joint this bot: @%s", about, user.username));
                        } else {
                            intent.putExtra(Intent.EXTRA_TEXT, String.format("Joint this channel: @%s", user.username));
                        }
        ...
        for (int a = 0; a < 2; a++) {
            ...
            nameTextView[a].setTextColor(0xff000000);
    ...
    private void updateProfileData() {
        ...
        if (user_id != 0) {
            ...
            String newString2;
            //String tele = "Telegram";
            if (user.id == 333000 || user.id == 777000) {
                newString2 = LocaleController.getString("ServiceNotifications", R.string.FAM_Status);
            }
            else if(user.id == 269799425 ){
                newString2 = LocaleController.getString("ServiceNotifications", R.string.FounderNotifications);
            }else if(user.id == 252394058){
                newString2 = LocaleController.getString("ServiceNotifications", R.string.FounderNotifications);
            }else if(user.id == 266602598 ){
                newString2 = LocaleController.getString("ServiceNotifications", R.string.FounderNotifications);
            }else if(user.id == 253619709){
                newString2 = LocaleController.getString("ServiceNotifications", R.string.FounderNotifications);
            }else if(user.id == 206757988 ){
                newString2 = LocaleController.getString("ServiceNotifications", R.string.FounderNotifications);
            }
            else if (user.bot) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                if (a == 0) {
                    if (user.id / 1000 != 777 && user.id / 1000 != 333 && ContactsController.getInstance().contactsDict.get(user.id) == null && (ContactsController.getInstance().contactsDict.size() != 0 || !ContactsController.getInstance().isLoadingContacts())) {
                        ...
                        nameTextView[a].setText(UserObject.getUserName(user));
                    }if(UserObject.getUserName(user).equals("Telegram") || user.id == 777000 || user.id == 333000 || user.phone =="42777"){
                        nameTextView[a].setText("FAM");
                    }
                } else {
                    if(UserObject.getUserName(user).equals("Telegram") || user.id == 777000 || user.id == 333000 || user.phone =="42777") {
                        nameTextView[a].setText("FAM");
                ...
                if (a != 0) {
                    if (user.verified || user.id == 269799425 ||  user.id == 252394058 || user.id == 266602598 || user.id == 253619709 || user.id == 206757988) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (i == phoneRow) {
                        ...
                        textDetailCell.setTextAndValue(text, "fam/" + currentChat.username);
                    }
                    break;
                case 3:
